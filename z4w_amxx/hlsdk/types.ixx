...
namespace std {
#ifndef CLIENT_DLL
	template<class T, std::size_t N> class tuple_size<::hlsdk::VectorBase<T, N>> : public std::integral_constant<std::size_t, N> {};
	template<class T, std::size_t N, std::size_t I> class tuple_element<I, ::hlsdk::VectorBase<T, N>> { public: using type = T; };
#else
	template<class T, std::size_t N> class tuple_size<::hlsdk::VectorBase<T, N>> : public std::integral_constant<std::size_t, N> {};
	template<class T, std::size_t N, std::size_t I> class tuple_element<I, ::hlsdk::VectorBase<T, N>> { public: using type = T; };
#endif
