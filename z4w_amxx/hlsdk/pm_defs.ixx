...
export namespace hlsdk {
	constexpr auto MAX_PHYSENTS = 600; 		  // Must have room for all entities in the world.
	constexpr auto MAX_MOVEENTS = 64;
	constexpr auto MAX_CLIP_PLANES = 5;

	constexpr auto PM_NORMAL = 0x00000000;
	constexpr auto PM_STUDIO_IGNORE = 0x00000001;		// Skip studio models
	constexpr auto PM_STUDIO_BOX = 0x00000002;		// Use boxes for non-complex studio models (even in traceline)
	constexpr auto PM_GLASS_IGNORE = 0x00000004;		// Ignore entities with non-normal rendermode
	constexpr auto PM_WORLD_ONLY = 0x00000008;		// Only trace against the world

	// Values for flags parameter of PM_TraceLine
	constexpr auto PM_TRACELINE_PHYSENTSONLY = 0;
	constexpr auto PM_TRACELINE_ANYVISIBLE = 1;
