...
// ============================================================================
// ==============================================================================
CQQWry::CQQWry(const char *pszFileName) : m_fpIpDataFile(fopen(pszFileName, "rb"))
{
    if(!m_fpIpDataFile)
...
// ============================================================================
unsigned long CQQWry::IpString2IpValue(const char* pszIp) const
{
...
//    根据ip值获取字符串（由点分割）
// ============================================================================
void CQQWry::IpValue2IpString(unsigned long ipValue,
	char* pszIpAddress,
	int nMaxCount) const
{
	if (!pszIpAddress) {
...
// ============================================================================
unsigned long CQQWry::SearchIp(unsigned long ipValue,
...
// ============================================================================
// ==============================================================================
unsigned long CQQWry::SearchIp(const char* pszIp,
	unsigned long indexStart,
	unsigned long indexEnd) const
{
	if (!this->IsRightIpString(pszIp)) {
...
// ==========================================================================================================
unsigned long CQQWry::GetValue3(unsigned long indexStart) const
{
	if (!m_fpIpDataFile) {
		return 0;
	}
...
// ==========================================================================================================
unsigned long CQQWry::GetValue4(unsigned long indexStart) const
{
	if (!m_fpIpDataFile) {
		return 0;
	}
...
//    从指定位置获取字符串
// ============================================================================
unsigned long CQQWry::GetString(std::string& str, unsigned long indexStart) const
{
	if (!m_fpIpDataFile) {
		return 0;
	}
...
//    ulOffset为Ip记录偏移量
// ============================================================================
void CQQWry::GetAddressByOffset(unsigned long ulOffset,
...
//    根据十六进制ip获取国家名地区名
// ============================================================================
void CQQWry::GetAddressByIp(unsigned long ipValue,
	std::string& strCountry,
	std::string& strLocation) const
{
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
//    根据ip字符串获取国家名地区名
// ============================================================================
void CQQWry::GetAddressByIp(const char* pszIp,
	std::string& strCountry,
	std::string& strLocation) const
{
	if (!this->IsRightIpString(pszIp)) {
...
// ============================================================================
unsigned long CQQWry::OutputData(const char* pszFileName,
	unsigned long indexStart,
	unsigned long indexEnd) const
{
...
//    通过ip值界定导出范围
// ==============================================================================
unsigned long CQQWry::OutputDataByIp(const char* pszFileName,
...
//    判断给定IP字符串是否是合法的ip地址
// ==============================================================================
bool CQQWry::IsRightIpString(const char* pszIp) const
{
	if (!pszIp) {
		return false;
	}
